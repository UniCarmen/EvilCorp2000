...
public partial class EvilCorp2000Context : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
       ...
       {
           //nicht notwendig, da Key in der Entity KLasse vorhanden
           entity.HasKey(e => e.DiscountId);
           //nicht notwendig, aber als Dokumentation gut
           entity.HasOne(d => d.Product)
               .WithMany(p => p.Discounts)
               .HasForeignKey(d => d.ProductId)
               //notwendig, da diese Zeile das kaskadierende Löschverhalten sicherstellt
               .OnDelete(DeleteBehavior.Cascade);
       });

        //TODO: wenn alles glatt läuft, sollte es auch ohne das funktionieren, da ich die EInstellungen in der Entityklasse habe
