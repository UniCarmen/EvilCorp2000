...
namespace DataAccess.Repositories
{
    public class CategoryRepository : ICategoryRepository
    {
        ...
        public async Task SaveNewCategory(Category category)
        {
            try
            {
                ThrowExceptionWhenNull(category, $"Category with id {category.CategoryId} is missing");
        ...
        public async Task DeleteCategory(Category categoryToDelete)
        {
            try
            {
                categoryToDelete = ThrowExceptionWhenNull(categoryToDelete, $"Category to delete with id {categoryToDelete.CategoryId} is missing");
